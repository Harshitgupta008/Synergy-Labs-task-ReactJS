...
const UpdateUser = () => {
    ...
    const SubmitUser = async (e) => {
        ...
        if (validate()) {
           ...
           return  alert("Please fix the errors and try again.");
        }
            ...
            <div className="flex items-center justify-center py-2  h-fit w-full">
                <form className="flex  flex-col h-fit w-fit gap-3">
                    ...
                    <div className="flex flex-col items-center justify-center my-3">
                        <button onClick={SubmitUser} className="h-fit w-full bg-customcolor text-white font-bold py-3  rounded-full">Update & Save</button>
                    </div>
                </form>
            </div>
